...
const ecosystemAreas = [
  { icon: Building2, title: 'Enterprise Clients', desc: 'Organizations running on Heraja infrastructure.', href: '/evidence/zimo-clan', color: '#231F20' },
  { icon: Users, title: 'ZIMO Clan', desc: 'Flagship enterprise implementation.', href: '/evidence/zimo-clan', color: '#7AC142' },
  { icon: Sprout, title: 'Pilot Programs', desc: 'Poultry & Fish Farming pilot, live today.', href: '/evidence/pilot', color: '#F99D1C' },
  { icon: Globe, title: 'Partners', desc: 'Technology and implementation partners.', href: '/evidence', color: '#4F9D5C' },
  { icon: FileText, title: 'Implementation Stories', desc: 'Real deployment outcomes and metrics.', href: '/evidence/zimo-clan', color: '#C9782B' },
  { icon: MapPin, title: 'Regional Programs', desc: 'Geographic deployment initiatives.', href: '/evidence', color: '#5FA83D' },
];
  ...
  return (
    <Layout>
      ...
      <CTABlock title="Join the Ecosystem" description="Become a partner or enterprise client building on Heraja infrastructure."
        primaryCta={{ label: 'Become a Partner', href: '/evidence' }} secondaryCta={{ label: 'Contact Us', href: '/company/contact' }} />
    </Layout>
  );
}
