...
export default function SolutionsOverview() {
  ...
  return (
    <Layout>
      <Seo title="Infrastructure for Every Agricultural Organization" description="Governments, cooperatives, enterprises, agribusinesses, financial institutions, and development organizations all run on the same underlying system." />
